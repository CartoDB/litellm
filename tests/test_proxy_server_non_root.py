...
def test_restructure_ui_html_files_skipped_in_non_root(monkeypatch):
    ...
    - ui_path matches the configured LITELLM_UI_PATH (default: /var/lib/litellm/ui)
    """
    ...
    # CARTO: Use env var for configurable path (matches proxy_server.py logic)
    configured_ui_path = os.getenv("LITELLM_UI_PATH", "/var/lib/litellm/ui")
    ui_path = configured_ui_path
